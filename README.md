...
❯ cat test/TestDdevConfig.log
Creating a new ddev project config in the current directory (/home/edgarl/go/src/github.com/hinshun/ddevexpect/test)
Once completed, your configuration will be written to /home/edgarl/go/src/github.com/hinshun/ddevexpect/test/.ddev/config.yaml
Project name (test):
The docroot is the directory from which your site is served. This is a relative path from your project root (/home/edgarl/go/src/github.com/hinshun/ddevexpect/test)
You may leave this value blank if your site files are in the project root
Docroot Location (current directory):
Found a php codebase at /home/edgarl/go/src/github.com/hinshun/ddevexpect/test.
Project Type [php, drupal6, drupal7, drupal8, wordpress, typo3, backdrop] (php):
